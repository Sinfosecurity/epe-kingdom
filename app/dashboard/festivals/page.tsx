    ...
    <div className="container mx-auto px-4 py-8">
        ...
        <div className="relative rounded-2xl overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-black/80 to-black/40 flex flex-col justify-center p-8">
            ...
            <p className="text-white/90 max-w-xl mb-6">
              Experience the vibrant cultural celebrations that showcase Epe's
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-invert max-w-none">
            <p className="text-gray-300 mb-4">
              Epe Kingdom is renowned for its vibrant festivals that celebrate
              its rich cultural heritage, historical events, and spiritual
              traditions. These festivals are not merely entertainment but serve
              as important vehicles for preserving and transmitting cultural
              knowledge, reinforcing community bonds, and connecting present
              generations with their ancestral roots.
            </p>
            <p className="text-gray-300 mb-4">
              Throughout the year, Epe comes alive with colorful celebrations
              that feature traditional music, dance, elaborate costumes, ritual
              ceremonies, and communal feasting. Each festival has its unique
              significance, often tied to agricultural cycles, historical
              events, religious observances, or ancestral veneration.
            </p>
            <p className="text-gray-300">
              Explore the major festivals of Epe Kingdom below and discover the
              rich tapestry of traditions that make this community's cultural
              heritage so distinctive and vibrant.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mb-16">
        <h2 className="text-2xl font-bold mb-8 text-white">
          Major Festivals of Epe
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {festivals.map((festival) => (
            <Card
              key={festival.id}
              className="bg-gray-900 border-gray-800 text-gray-100 overflow-hidden group"
            >
              ...
              <CardFooter>
                <Link href={`/dashboard/festivals/${festival.id}`}>
                  <Button
                    variant="outline"
                    className="bg-purple-90/30 border-purple-600 text-white hover:bg-white hover:text-purple-900/30"
                  >
        ...
        <div className="bg-gray-900/50 rounded-2xl p-6 md:p-8 border border-gray-800">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-300">
                Experience the rhythmic beats of traditional drums, melodious
                songs, and energetic dance performances that have been passed
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-300">
                Witness the coming together of families, community groups, and
                visitors in a spirit of unity, celebration, and shared cultural
                pride.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-300">
                Observe sacred rituals, traditional ceremonies, and spiritual
                practices that connect the community with its ancestral heritage
                and cultural roots.
              </p>
            </div>
          </div>
      ...
      <section>
        <div className="bg-purple-900/30 rounded-2xl p-8 text-center border border-purple-800/50">
          <h2 className="text-2xl font-bold mb-4 text-white">
            Experience Epe's Cultural Celebrations
          </h2>
          <p className="text-gray-300 max-w-2xl mx-auto mb-6">
            Plan your visit to coincide with one of Epe's vibrant festivals and
            immerse yourself in the rich cultural heritage of this historic
            kingdom.
          </p>
