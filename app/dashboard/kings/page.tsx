...
export default function KingsPage() {
  ...
  const timeline = [
    {
      ...
      events:
        "Early traditional rulers governed Epe, with leadership structures based on Yoruba traditional systems.",
    },
    {
      period: "Mid-19th Century",
      events:
  ...
  return (
    <div className="container mx-auto px-4 py-8">
        ...
        <div className="relative rounded-2xl overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-black/80 to-black/40 flex flex-col justify-center p-8">
            <h1 className="text-3xl md:text-4xl font-bold text-white mb-4 max-w-xl">
              The Kings of Epe Kingdom
            </h1>
            <p className="text-white/90 max-w-xl mb-6">
              Discover the royal lineage and rich monarchical history of the
              Oluepe of Epe, from ancient times to the present day.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-invert max-w-none">
            <p className="text-gray-300 mb-4">
              The institution of the Oluepe (King of Epe) represents one of the
              oldest and most respected traditional leadership structures in
              Lagos State. The monarchy has played a crucial role in preserving
              the cultural heritage, maintaining social cohesion, and guiding
              the development of Epe throughout its history.
            </p>
            <p className="text-gray-300 mb-4">
              The Oluepe serves as both a political leader and a cultural
              custodian, embodying the values, traditions, and aspirations of
              the people of Epe. The position combines elements of traditional
              Yoruba kingship with influences from Islamic traditions that
              became prominent in the region during the 19th century.
            </p>
            <p className="text-gray-300">
              Throughout the colonial period, independence, and into the modern
              era, the institution of the Oluepe has evolved while maintaining
              its cultural significance. Today, the Oluepe continues to play an
              important role in community leadership, cultural preservation, and
              development initiatives, working alongside modern governmental
              structures.
            </p>
          </div>
        </div>
          ...
          {timeline.map((item, index) => (
            <div key={index} className="flex flex-col md:flex-row items-center">
              ...
              <div
                className={`md:w-1/2 ${
                  index % 2 === 0
                    ? "md:order-2 md:pl-12 hidden md:block"
                    : "md:pr-12 hidden md:block md:text-right"
                }`}
              >
        ...
        <div className="space-y-8">
          {kings.map((king, index) => (
            <div
              ...
              } bg-gray-900/50 rounded-2xl overflow-hidden border border-gray-800`}
            >
              <div className="md:w-1/3">
                <div className="relative h-full min-h-[300px]">
                  <Image
                    src={king.image || "/placeholder.svg"}
                    alt={king.name}
                    fill
      ...
      <section className="mb-16">
        <h2 className="text-2xl font-bold mb-8 text-white">
          Royal Symbols & Regalia
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {royalSymbols.map((symbol, index) => (
            <Card
              key={index}
              className="bg-gray-900 border-gray-800 text-gray-100 overflow-hidden"
            >
            ...
            <div className="md:w-1/2">
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-300">
                    At the apex of the traditional governance structure is the
                    Oluepe, who serves as the paramount ruler and final
                    authority on traditional matters. The Oluepe is selected
                    from royal lineages according to established succession
                    practices.
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-gray-300">
                    The Oluepe is supported by a council of chiefs, each
                    representing different aspects of community life or specific
                    areas within the kingdom. These chiefs serve as advisors to
                    the king and help in the administration of traditional
                    affairs.
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-gray-300">
                    A select group of high-ranking chiefs known as kingmakers
                    plays a crucial role in the selection and installation of a
                    new Oluepe when the throne becomes vacant. They ensure that
                    succession follows traditional protocols and that the
                    selected candidate meets the required criteria.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="bg-gray-900 border-gray-800 text-gray-100">
            ...
            <CardContent>
              ...
              />
              <p className="text-gray-300">
                The installation of a new Oluepe involves elaborate rituals that
                span several days. The ceremony includes traditional rites,
                prayers, and public celebrations that officially transfer the
                authority and spiritual mandate to the new king.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gray-900 border-gray-800 text-gray-100">
            ...
            <CardContent>
              ...
              />
              <p className="text-gray-300">
                During important festivals and events, the Oluepe leads royal
                processions through Epe. These processions feature traditional
                music, dance, and displays of royal regalia, allowing the
                community to honor their king and celebrate their cultural
                heritage.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gray-900 border-gray-800 text-gray-100">
            ...
            <CardContent>
              ...
              />
              <p className="text-gray-300">
                Important announcements and decisions are traditionally made by
                the Oluepe through formal declarations. These are communicated
                to the community through town criers or during special
                gatherings, maintaining the oral tradition of royal
                communications.
              </p>
            </CardContent>
          </Card>
      ...
      {/* <section>
        <div className="bg-purple-900/30 rounded-2xl p-8 text-center border border-purple-800/50">
          <h2 className="text-2xl font-bold mb-4 text-white">
            Visit the Royal Palace of Epe
          </h2>
          <p className="text-gray-300 max-w-2xl mx-auto mb-6">
            Experience the rich royal heritage of Epe Kingdom by visiting the
            palace. Learn about the monarchy's history, view royal artifacts,
            and immerse yourself in the cultural traditions that have shaped Epe
            for generations.
          </p>
